...
class ui():
    ...
    def run(self):
        ...
        roll = float(
            input("Please enter the roll of your desired orientation in radians: "))
        pitch = float(
            input("Please enter the pitch of your desired orientation in radians: "))
        yaw = float(
            input("Please enter the yaw of your desired orientation in radians: "))
